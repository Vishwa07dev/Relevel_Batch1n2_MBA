...
module.exports = (app) => {
    ...
    app.put("/mba/api/v1/bookings/:bookingId", [authUser.verifyToken, authBooking.isAdminOrBookingOwner], bookingController.updateBookings);
    app.get("/mba/api/v1/bookings/", [authUser.verifyToken], bookingController.listBookings);
    app.get("/mba/api/v1/bookings/:bookingId", [authUser.verifyToken, authBooking.isValidBookingId], bookingController.getBookingDetails);
