...
module.exports = (app) => {
    ...
    app.put("/mba/api/v1/theatres/:theatreId/movies/:movieId", [theatreCheckPoint.checkParams, theatreCheckPoint.isValidTheatre, movieCheckPoint.isValidMovie], theatreController.addMovieInsideTheatre);
    ...
    app.get("/mba/api/v1/theatres/:id/movies/", [theatreCheckPoint.isValidTheatre], theatreController.getAllMoviesFromTheatre);
